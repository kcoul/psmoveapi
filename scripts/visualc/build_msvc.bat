...
cmake .. -G "%MSVC_CMAKE_GENERATOR%" -A "%MSVC_CMAKE_ARCH%" -DPSMOVE_USE_PS3EYE_DRIVER=ON -DPSMOVE_BUILD_TRACKER=ON -DPSMOVE_BUILD_OPENGL_EXAMPLES=ON -DOpenCV_DIR=./external/opencv/build-%MSVC_PLATFORM%/
IF !ERRORLEVEL! NEQ 0 (
